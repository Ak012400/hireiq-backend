...
public class MLService
{
    ...
    /// <summary>
    /// Stub for IAiService.GetEmbeddingAsync — Phase 1 returns empty until embedding endpoint is wired.
    /// Phase 7 (Job Matching) will implement semantic embeddings here.
    /// </summary>
